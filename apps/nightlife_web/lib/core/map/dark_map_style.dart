/// Vexda dark map style — copied from the mobile app (`nightlife_app`).
///
/// The mobile JSON uses a fractional highway stroke weight. Flutter Web requires
/// integer weights, so only that rule differs here (`weight: 1` + alpha colour).
class DarkMapStyle {
...
[
  ...
  {"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"color":"#6644516B"},{"weight":1}]},
