...
/// Formats Firestore opening hours for the venue information panel.
class VenueOpeningHoursFormatter {
  ...
  static List<VenueOpeningHoursEntry> fromMap(Map<String, dynamic> hours) {
    ...
    return _dayKeys.map((key) {
      ...
      return VenueOpeningHoursEntry(
        dayLabel: _dayLabels[key] ?? key,
        hoursLabel: open != null && close != null ? '$open – $close' : 'Hours unavailable',
        isToday: key == todayKey,
      );
    }).toList();
  }
