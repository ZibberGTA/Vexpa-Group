...
/// Ranking rules for unified search — aligned with mobile priorities.
class SearchRanking {
  SearchRanking._();

  static int score(SearchVenueMatch match, String query) {
    ...
    score += (match.matchedDrinks.length +
  ...
  static void sortMatches(List<SearchVenueMatch> matches, String query) {
    matches.sort((a, b) {
