/// Opening-hours helpers for discovery venue cards.
class SearchVenueOpenStatus {
  const SearchVenueOpenStatus({required this.isOpen, this.hasHours = false});
  ...
  /// Returns whether a venue is open now based on [openingHours].
  ///
