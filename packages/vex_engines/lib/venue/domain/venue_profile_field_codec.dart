...
/// Encodes and validates venue profile fields for persistence.
final class VenueProfileFieldCodec {
  ...
  static List<String> displayFeatureTags({
    required List<String> featureTags,
    required List<String> features,
  }) {
    final tags = featureTags.isNotEmpty ? featureTags : features;
  ...
  static Map<String, dynamic> buildFeatureTagsUpdate({
    ...
    return {'featureTags': labels, 'venueFeatures': venueFeatures};
  }
